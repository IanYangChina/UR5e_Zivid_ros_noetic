...
from utils.poses import construct_homogeneous_transform_matrix


script_path = os.path.dirname(os.path.realpath(__file__))
if not os.path.exists(os.path.join(script_path, '..', 'src', 'zivid_cam_intrinsics.yml')):
    raise OSError("\nIntrinsics file not found: {}\n"
                  ...
                  .format(os.path.join(script_path, '..', 'src', 'zivid_cam_intrinsics.yml')))

with open(os.path.join(script_path, '..', 'src', 'zivid_cam_intrinsics.yml')) as intrinsics_file:
...
class Sample:
    def __init__(self):
        ...
        rospy.loginfo("Starting live_zivid_2d.py")
        ...
        self.aruco_pose_in_cam_frame = None
    ...
    def aruco_pose_callback(self, msg):
        ...
        self.aruco_pose_in_cam_frame = msg
        rospy.loginfo("Current marker pose in world frame: \n{}".format(self.aruco_pose_in_cam_frame))
